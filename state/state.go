...
import (
	...
	"github.com/DCNT-Hammer/dcnt/common/constants/runstate"
	...
	"github.com/DCNT-Hammer/dcnt/database/boltdb"
	"github.com/DCNT-Hammer/dcnt/database/databaseOverlay"
	"github.com/DCNT-Hammer/dcnt/database/leveldb"
	"github.com/DCNT-Hammer/dcnt/database/mapdb"
	"github.com/DCNT-Hammer/dcnt/p2p"
	"github.com/DCNT-Hammer/dcnt/util"
	"github.com/DCNT-Hammer/dcnt/util/atomic"
	"github.com/DCNT-Hammer/dcnt/wsapi"
	"github.com/DCNT-Hammer/logrustash"

	"regexp"

	"github.com/DCNT-Hammer/dcnt/Utilities/CorrectChainHeads/correctChainHeads"
...
func (s *State) LoadConfig(filename string, networkFlag string) {
	...
	if len(filename) > 0 {
		...
		s.MainSeedURL = "https://raw.githubusercontent.com/DCNT-Hammer/DCNT-Hammer.github.io/master/seed/mainseed.txt"
		s.MainSpecialPeers = ""
		s.TestNetworkPort = "8109"
		s.TestSeedURL = "https://raw.githubusercontent.com/DCNT-Hammer/DCNT-Hammer.github.io/master/seed/testseed.txt"
		s.TestSpecialPeers = ""
		s.LocalNetworkPort = "8110"
		s.LocalSeedURL = "https://raw.githubusercontent.com/DCNT-Hammer/DCNT-Hammer.github.io/master/seed/localseed.txt"
		s.LocalSpecialPeers = ""
